...
| **最後更新** | 2026-02-10 | 詳見 [工作記錄.md](./工作記錄.md) |
...
8. **🔴 禁止擅自生成程式代碼（CRITICAL - 2026-02-12 新增）** - **完全禁止**在未檢查規範前生成任何程式代碼建議。必須先讀取 README、架構文件、檢查 i18n key、API 端點、資料模型等。擅自生成程式會導致整個程式崩潰。詳見規則 #12。
