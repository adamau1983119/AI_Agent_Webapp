...
> **對齊**：`專案完整架構表.md` →「建立頻道 Step 2／RSS」§⑤  
> **原則**：先定 **備援 UX** 與 **檢索 MVP**，再鎖 API 契約與 UI。  
> **更新**：2026-05-08（**§E Phase A** 助手優先版面凍結）  
...
**目標版面（v0.2）**：見 **§E「助手優先（Assistant-first）」**—預設 **主舞台僅助手**，表單收斂至 **摘要／進階**；備援與「關閉助手」語意由 **L4 進階** 承接。
...
1. **C1**：助手頂部引導文案＋備援出口（關閉助手）。**版面主從** 以 **§E** 為準（Phase B 起「預設即助手」）。
...
1. 讀完 **§E** 能說明：**誰是主畫面**、**表單在哪一層**、**進階何時出現**。  
...
| **Phase D** | `data-testid`、**D.1** 手測腳本、建置煙霧；瀏覽器 E2E 見測試週 | ✅ 2026-05-09（開發可驗） |
...
| 項目 | 狀態 |
|------|------|
| 本規格文件 | ✅ v0.2（§E Phase A 凍結） |
| **助手優先（Assistant-first）版面 UI** | ✅ 2026-05-09；見 **§E**、`channel_create_new_scheme_checklist.md` **B～D** |
