...
> **更新日期**：2026-09-02（**公眾主題卡產出時契約**、全站正文截斷、GET 僅 overlay；PR #51／#52）  
> **分支**：正式域映像追 `main`（PR #52 正文截斷 `7d55dc3`、PR #51 產出契約 `2f6607e`、PR #39 image `6fa295d`、PR #38 dedup `4819e99`）  
...
| `/dashboard` | Dashboard | **顯示** | **v8 登入預設首屏**；今日頭條 Tab（全部／時尚／美食／趨勢）＋「更多」→ `/topics?category=`；HKT N/15（`topicDayHkt.ts`） |
| `/topics` | Topics | **顯示** | 可讀 `?category=fashion\|food\|trend` 接無限滾 |
