...
> **更新日期**：2026-09-04（**精選照片最多 4 張 2×2** 進行中 `feature/v8-featured-photos`；點數／Stripe 規格已鎖、改碼後補）  
> **分支**：正式域映像追 `main`（PR #58 組裝器 `d5457dc`、PR #57 分類 Tab `a2fb8bf`、PR #56 Dashboard IA `90acb34`、PR #52 正文截斷 `7d55dc3`、PR #51 產出契約 `2f6607e`）  
...
|------|------------|------------------------|
| 程式基線 | `9556ea7` 已合 `main`（PR #17） | OBS＋PR #19 Resend＋PR #24 HKT＋PR #38/39 搜圖＋**事實錨定／源文章翻譯**＋**PR #51 產出契約**＋**PR #52 正文截斷** |
...
| **實體硬門禁** | 手動測試 | **Git Pre-Commit 5 道實體門禁**（結構 + i18n **1122** 鍵 + 管線審計 + 語言 14 項 + 防線／抽取含 compose） |
