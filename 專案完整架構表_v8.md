...
> **更新日期**：2026-07-31（**條件上架 → 可進日常運作測試**：collection ✅ · OBS 旗標／Deploy ✅ · 產卡對齊 04:00 HKT）  
> **分支**：`feature/v8-observability-alerting`（上架熱修／Observability；託管曾用 `feature/v8-launch`）  
...
> **Observability**：[docs/v8_observability_alerting.md](./docs/v8_observability_alerting.md)  
> **日收備份**：[docs/backups/2026-07-31_v8_daily_ops_ready_snapshot/](./docs/backups/2026-07-31_v8_daily_ops_ready_snapshot/SNAPSHOT_README.md) · [2026-07-30](./docs/backups/2026-07-30_v8_hosting_b_day2_snapshot/SNAPSHOT_README.md) · [2026-07-29](./docs/backups/2026-07-29_v8_hosting_b_snapshot/SNAPSHOT_README.md)  
...
| 項目 | v7（凍結） | v8（2026-07-31） |
|------|------------|------------------|
| 程式基線 | `9556ea7` 已合 `main`（PR #17） | 同基線；熱修／OBS 走 feature 分支 → 須進部署映像 |
| 測試 | 上架衝刺三日主路已過 | **正式域日常運作測試**（自動產卡＋digest） |
...
| 告警 | 無 | Observability：紅燈＋每日報告（Railway 旗標已開） |
| 文件 SoT | archives 凍結檔 | **本檔** |
| **上架判決** | — | **條件上架・可進日常運作測試**（阻塞：密鑰輪換；OBS 映像確認；E 產卡煙霧待 08-01） |
...
| **Observability** | Railway：Gmail + Watchdog + Daily digest 旗標已開；見 [`v8_observability_alerting.md`](./docs/v8_observability_alerting.md) |
| **上架判決** | **條件上架・可進日常運作測試** |
| **殘餘阻塞 ≤3** | ① 密鑰輪換；② OBS／主題卡熱修是否已進部署映像；③ 08-01 自動產卡＋digest 煙霧 |
