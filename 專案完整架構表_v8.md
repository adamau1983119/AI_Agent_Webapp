...
> **更新日期**：2026-09-03（**Dashboard 分類 Tab 直接歷史**、`?tab=`、詳情返回頭條；PR #56 全部拆三類＋已讀變灰）  
> **分支**：正式域映像追 `main`（PR #56 Dashboard IA `90acb34`、PR #52 正文截斷 `7d55dc3`、PR #51 產出契約 `2f6607e`、PR #39 image `6fa295d`、PR #38 dedup `4819e99`）  
...
| **實體硬門禁** | 手動測試 | **Git Pre-Commit 5 道實體門禁**（結構 + i18n 1093 鍵值 + 管線審計 + 語言 14 項 + 防線／抽取 22 項） |
