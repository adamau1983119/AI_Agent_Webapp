...
> **分支**：\eature/v8-launch\  
> **v7 凍結（唯讀）**：tag \7.0.0-code-freeze\ · [docs/archives/v7.0.0_專案完整架構表_凍結.md](./docs/archives/v7.0.0_專案完整架構表_凍結.md) · [7.0.0_CODE_FREEZE_MANIFEST.md](./docs/archives/v7.0.0_CODE_FREEZE_MANIFEST.md)  
...
| 項目 | v7（凍結） | v8（進行中） |
|------|------------|--------------|
| 程式基線 | \9556ea7\ 已合 \main\ | 同基線起改 |
| 測試 | 上架衝刺三日主路已過 | **正式域／真實運行數據** |
| DNS／OAuth | 未接 | Spaceship + 正式 \.env\ |
