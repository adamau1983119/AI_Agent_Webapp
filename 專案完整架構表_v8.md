...
> **更新日期**：2026-09-15（**主題卡痛點 1～4** 於 `feature/v8-topic-card-painpoints`；PR #64 金流履約已合 `main` `fcf70b5`）  
> **分支**：正式域映像追 `main`（PR #64 金流履約 `fcf70b5`、PR #62 精選照片 `1aaf098`、PR #59 金流 `72b18a0`、PR #58 組裝器 `d5457dc`、PR #52 正文截斷 `7d55dc3`、PR #51 產出契約 `2f6607e`）；痛點改碼見 `feature/v8-topic-card-painpoints`  
...
|------|------------|------------------------|
| 程式基線 | `9556ea7` 已合 `main`（PR #17） | OBS＋PR #19 Resend＋PR #24 HKT＋PR #38/39 搜圖＋**事實錨定／源文章翻譯**＋**PR #51 產出契約**＋**PR #52 正文截斷**＋**PR #58 組裝器**＋**PR #59／#64 金流**＋**PR #62 精選照片 4 張**＋**痛點 1～4（feature 待合）** |
...
| **點數／金流** | 一次發 5 點、無結帳 | **PR #59**：歡迎 3×10 後每日 +5（免費帽 10、7 日到期）；購買 US$3/5/10 不過期；Mongo wallet SoT；無 Stripe 金鑰 **503** |
...
| 版本 | 日期 | 更新 |
|------|------|------|
| **v8.0.5-topic-card-painpoints** | 2026-09-15 | 痛點 1～4：boilerplate 擴詞＋顯示層清洗；事實摘要／translate-source-article；object-top＋計數 4；下載 JPG；分支 `feature/v8-topic-card-painpoints`（待合 main） |
