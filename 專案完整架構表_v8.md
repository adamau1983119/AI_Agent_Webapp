...
> **更新日期**：2026-09-04（**精選照片 4 張 2×2** 於 `feature/v8-featured-photos` 已合入含 PR #59／#61 之 `main`；待功能 PR 合正式域）  
> **分支**：正式域映像追 `main`（PR #59 金流 `72b18a0`、PR #61 文件 `5cd5583`、PR #58 組裝器 `d5457dc`、PR #57 分類 Tab `a2fb8bf`、PR #56 Dashboard IA `90acb34`、PR #52 正文截斷 `7d55dc3`、PR #51 產出契約 `2f6607e`）  
...
|------|------------|------------------------|
| 程式基線 | `9556ea7` 已合 `main`（PR #17） | OBS＋PR #19 Resend＋PR #24 HKT＋PR #38/39 搜圖＋**事實錨定／源文章翻譯**＋**PR #51 產出契約**＋**PR #52 正文截斷**＋**PR #58 組裝器**＋**PR #59 金流** |
...
| **精選照片** | 匹配綁長文、預設湊 8 | **最多 4 張 2×2**；事實錨 `summary_flash`→原文→標題；空庫可匹配；不改產卡 `preview_images: 1` |
...
| **實體硬門禁** | 手動測試 | **Git Pre-Commit 5 道實體門禁**（結構 + i18n 三語對齊 + 管線審計 + 語言 14 項 + 防線／抽取含 compose） |
...
| 版本 | 日期 | 更新 |
|------|------|------|
| **v8.0.4-featured-photos** | 2026-09-04 | 精選最多 4 張 2×2；`match_facts` 錨 `summary_flash`→原文→標題；合入含 PR #59 之 `main` |
