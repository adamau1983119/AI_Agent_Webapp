...
> **更新日期**：2026-09-16（**Compose advanced** `feature/v8-compose-advanced`；含 Py3.11 f-string hotfix；Welcome 價錢 Inter **PR #67** 已合）  
> **分支**：正式域映像追 `main`（PR #67 Welcome 價錢、PR #65 痛點、PR #64 金流履約、PR #62 精選照片、PR #59 金流、PR #58 組裝器）；**組裝進階**見 `feature/v8-compose-advanced`（含 `compose_prompt` Py3.11 hotfix）  
...
|------|------------|------------------------|
| 程式基線 | `9556ea7` 已合 `main`（PR #17） | OBS＋PR #19 Resend＋PR #24 HKT＋PR #38/39 搜圖＋**事實錨定／源文章翻譯**＋**PR #51 產出契約**＋**PR #52 正文截斷**＋**PR #58 組裝器**＋**PR #59／#64 金流**＋**PR #62 精選照片 4 張**＋**PR #65 痛點 1～4**＋**PR #67 Welcome 價錢 Inter**＋**Compose advanced（feature 待合）** |
...
| 版本 | 日期 | 更新 |
|------|------|------|
| **v8.0.6-compose-advanced** | 2026-09-16 | Compose advanced：100／150／500、兩段 body→meta、Keep／草稿／intent、`/compose-sample`；**hotfix**：`compose_prompt` 避開 Py3.11 f-string 反斜線（Railway crash） |
