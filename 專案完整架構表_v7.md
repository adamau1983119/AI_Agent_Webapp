...
> **v7 已凍結（2026-07-29）**：本檔進入**唯讀保全**；完整快照見 [docs/archives/v7.0.0_專案完整架構表_凍結.md](./docs/archives/v7.0.0_專案完整架構表_凍結.md) · Git tag `v7.0.0-code-freeze`。  
> **上架／測試／熱修／OPS-DIGEST SoT 改為 v8**：[專案完整架構表_v8.md](./專案完整架構表_v8.md)（**2026-08-10**：正式域日報 SMTP 現況見 v8 Observability 節）。  
